...
// ── Global definitions (single definition for the whole project) ──────────────
U8G2_SSD1306_128X64_NONAME_F_HW_I2C u8g2(U8G2_R0, U8X8_PIN_NONE, 22, 21); // SCL=22, SDA=21
...
void setup() {
  ...
  if (oledBrightness == 0 || oledBrightness == 0xFF) oledBrightness = 100; // safe default
  u8g2.begin();
